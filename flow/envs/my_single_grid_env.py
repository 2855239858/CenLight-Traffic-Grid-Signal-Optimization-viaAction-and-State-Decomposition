...
class MyTrafficLightGridEnv(Env):
    ...
    * discrete: determines whether the action space is meant to be discrete or
    ...
    def compute_reward(self, rl_actions, **kwargs):
        ...
        return rewards.wait_num_cars(self,rl_actions,**kwargs)
...
class MyTrafficLightGridPOEnv(MyTrafficLightGridEnv):
    """Environment used to train traffic lights.
...
class MyTrafficLightGridTestEnv(MyTrafficLightGridEnv):
    """
