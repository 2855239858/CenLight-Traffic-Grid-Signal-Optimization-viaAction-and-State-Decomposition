...
############################################################################
    ...
    global_counter = 0
    each_line_path = "collected_data/rnn/{}_plot_log.txt".format(NAME)
    test_epoch_path = "collected_data/rnn/{}_epoch_log.txt".format(NAME)
    ...
    if pre_train == 1:
        for pre in range(1000):
            ...
            for pre_step in range(steps):
                ...
                rnn_agent.experience_store(_state, action, rewards)
                pre_ep_r += rewards
